...
const socket = io(`${process.env.NEXT_PUBLIC_API_URL}`); // Conecta al servidor
...
export function ChatContent({ chat, loggedUsername }: { chat: Chat | null, loggedUsername?: string }) {
    ...
    useEffect(() => {
        ...
        const fetchMessages = async () => {
            ...
            try {
                const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/chat/${chat.chatId}/messages`);
